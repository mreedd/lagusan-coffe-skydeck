...
try {
    ...
    if (!$stmt) {
        error_log('DB prepare failed in orders.php: ' . $conn->error);
...
<main class="main-content">
    ...
    <div class="filters-bar">
        <form method="GET" class="filters-form">
            ...
            <button type="button" onclick="window.location.href='orders.php'" class="btn-secondary">Clear Filters</button>
        </form>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php endif; ?>
                        <?php if ($order['status'] === 'pending' && (has_role('admin') || has_role('cashier'))): ?>
                        <button onclick="voidOrder(<?php echo $order['id']; ?>)" class="btn-icon" title="Void Order" style="color: #dc3545;">
                            ❌
                        </button>
                        <?php endif; ?>
...
<div id="passwordModal" class="modal">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <p>Please enter the admin password to confirm order void:</p>
...
function completeOrder(orderId) {
    ...
    .then(data => {
        ...
        if (data.success) {
            ...
            window.location.href = 'orders.php'; // Redirect to show all orders
        } else {
...
function voidOrder(orderId) {
    ...
    console.log('Void order called for ID:', orderId, 'User role:', userRole);
    ...
    if (userRole === 'cashier') {
        ...
        console.log('Showing confirmation dialog for admin/staff');
        // For admin and staff, proceed directly with confirmation
        if (confirm('Are you sure you want to void this order? This will restore the inventory and mark the order as voided.')) {
            proceedWithVoid(orderId);
        }
    }
}
...
document.getElementById('passwordForm').addEventListener('submit', function(e) {
    ...
    proceedWithVoid(currentOrderId, password);
});
